...
interface MapStubSectionProps {
  stateName: string;
}

export default function MapStubSection({ stateName }: MapStubSectionProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 md:mb-12">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-dark">
            See Breeders on a Map
          </h2>
        </div>

        <div className="bg-pet-bg border-2 border-dashed border-pet-stroke rounded-2xl min-h-[400px] flex flex-col items-center justify-center text-center px-6 py-12">
          ...
          <p className="text-base text-nav-text max-w-md mb-8">
            We&apos;re working on an interactive map of all verified breeders in {stateName}. Want to know when it goes live?
          </p>
          <Link
            href="#claim-listing"
