...
export default function BrowseByStateSection(): JSX.Element {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-12">
          ...
          <p className="mt-4 text-base text-nav-text max-w-2xl">
            Find verified dog breeders close to home. Pick a state to see who&rsquo;s listed near you.
          </p>
        </div>
